...
public class ResultController {
    ...
    public ApiResponse<ResultResponse.SuccessOrFailResponseDto> getSuccessResultRecordData(@RequestParam Long processId, @RequestParam int page){
    ...
    @Operation(summary = "성공 데이터 결과 조회", description = "프로세스 아이디를 입력받아 성공, 실패 데이터 반환")
    public ApiResponse<ResultResponse.SuccessOrFailResponseDto> getFailResultRecordData(@RequestParam Long processId, @RequestParam int page){
